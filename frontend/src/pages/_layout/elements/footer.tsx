const Footer = () => {
  return (
    <div>
      ...
      <div className="footer-bottom"><div className="secure-logo"><div><img src="https://wver.sprintstaticdata.com/v3/static/front/img/ssl.png" alt="SSL" /></div><div className="ml-2"><b>100% SAFE</b><div>Protected connection and encrypted data.</div></div></div><div className="d-inline-block"><button className="btn p-0"><img src="https://versionobj.ecoassetsservice.com/v18/static/front/img/18plus.png" alt="18+" /></button><a href="https://www.gamcare.org.uk/" ><img src="https://versionobj.ecoassetsservice.com/v18/static/front/img/gamecare.png" alt="GamCare" /></a><a href="https://www.gamblingtherapy.org/" ><img src="https://versionobj.ecoassetsservice.com/v18/static/front/img/gt.png" alt="Gambling Therapy" /></a></div></div>
      <div className="footer-text"><p></p><p className="text-center">© Copyright 2024. All Rights Reserved. Powered by DIAMONDEXCH99.</p></div>
    </div>
  )
}
